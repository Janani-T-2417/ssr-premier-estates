...
export default function About() {
  return (
    <>
      <Helmet>
        <title>About SRR Group — Luxury Real Estate Developer in Vijayawada</title>
        <meta name="description" content="Discover the legacy, mission and vision of SRR Group — crafting master-planned luxury communities across Andhra Pradesh." />
        <meta property="og:title" content="About SRR Group" />
        <meta property="og:description" content="A legacy of luxury living engineered for generations." />
      </Helmet>
      <PageShell>
        <PageHero
          eyebrow="ABOUT SRR GROUP"
          title="A legacy of"
